...
**One-liner:** Owlry is a gamified reading app where you ask an owl what to read for how you feel, get a hand‑written *peek* that lets you taste a book before you commit, and keep a warm daily reading habit alive through a light XP/ink economy.
...
- **Commitment is expensive.** A book is hours of your life; readers can't cheaply tell whether it's *for them right now*.
- **The habit is fragile.** Without a reason to return daily, reading falls off the calendar.

**Opportunity:** a warm, characterful curation layer + a low-pressure habit loop that makes *starting* a book feel like opening a peek, and *returning* feel like tending a streak.
...
**Goals (v1)**
- Make discovery feel like receiving a personal peek, not browsing a catalog.
- Let readers peek a book's substance before committing.
...
**Overlays**
- **Peek** — the flagship artifact: a hand-written paper card with the book's opening feeling, real chapter, a ~60–90 word core argument, exactly three insights (with at most one genuine quote), a closing, two takeaways, two questions, and further-reading neighbours.
...
5. **Your first peek arrives** (Act IV), then **Mirror** is introduced (Act V) — "it watches what you read… and charts who you're becoming."
...
| **Peek** — first chapters (teal) | Reads beginnings so you can taste before committing | The peek header | Impatient, breezy, candid; never oversells. |
...
*(Gold is the house colour — light, peeks, XP, the streak flame — never an owl's.)*
...
| **Peek** — open a generated one | **−2** | +10 | Charged up front, refunded on failure; re-opening a cached peek is free |
| **Open a curated peek** | — | +5 | The 7 hand-written guides — no ink cost |
...
- **Guides:** **7** hand-written **peeks** — the classic/offline owl product and the quality bar for live peeks. Catalog books reuse their curated peek; open-world books are LLM-generated but rendered identically.
...
- **Peek→read conversion:** % of peeks that lead to opening the Reader / saving the book.
...
**Shipped / live**
- Four screens, the five-owl cast, the peek system, the reading economy, the "Opening Night" onboarding, two Scout desks, full-bleed mobile, and the optional live AI owl with offline fallback.

**Near-term**
- Deploy & bench the live peek quality against the 7-guide bar across both desks.
...
- Catalog growth strategy: curated depth vs. open-world breadth (live-generated peeks)?
