...
const en = {
  ...
  emptyBody: 'Bring your own EPUB, PDF, or TXT. Signed in, your copy follows your account; as a guest it stays on this device.',
...
const zh: typeof en = {
  ...
  emptyBody: '带上你自己的 EPUB、PDF 或 TXT。登录后，你的副本会跟随账号；游客模式下只留在这台设备上。',
  uploadBtn: '上传你的藏书',
  keepLooking: '再逛逛',
