...
const en = {
  ...
  errorTitle: 'this copy wouldn’t open.',
  errorFallback: 'something went sideways — try again in a moment.',
  retryBtn: 'TRY AGAIN',
  chooseAnotherBtn: 'CHOOSE ANOTHER FILE',
  emptyTitle: 'keeper here — the free shelves don’t carry this one.',
  emptyBody: 'Bring your own EPUB, PDF, or TXT. Signed in, your copy follows your account; as a guest it stays only for this reading session.',
...
const zh: typeof en = {
  ...
  retryBtn: '再试一次',
  chooseAnotherBtn: '换一个文件',
  emptyTitle: 'keeper 在此——免费书架上没有这一本。',
  emptyBody: '带上你自己的 EPUB、PDF 或 TXT。登录后，你的副本会跟随账号；游客模式下仅在本次阅读会话中保留。',
  uploadBtn: '上传你的藏书',
  keepLooking: '再逛逛',
