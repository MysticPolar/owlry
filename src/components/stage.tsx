...
export function CurtainValance() {
  return (
    <svg className="pb-valance" viewBox="0 0 370 106" preserveAspectRatio="none" aria-hidden="true">
      ...
      <path d="M370,64 Q347,92 324,64 Q301,92 278,64 Q255,92 231,64 Q208,92 185,64 Q162,92 139,64 Q116,92 92,64 Q69,92 46,64 Q23,92 0,64" fill="none" stroke="#FFD100" strokeWidth="3" />
      <rect x="0" width="370" height="4" fill="#E6BC00" />
      <rect x="68" y="86" width="2" height="9" fill="#FFD100" /><ellipse cx="69" cy="99" rx="4.5" ry="7" fill="#FFD100" />
      <rect x="300" y="86" width="2" height="9" fill="#FFD100" /><ellipse cx="301" cy="99" rx="4.5" ry="7" fill="#FFD100" />
    </svg>
  );
}
...
export function CurtainHem() {
  return (
    <svg className="pb-hem" viewBox="0 0 370 14" aria-hidden="true">
      ...
      <path d="M370,6 Q358,13 347,6 Q335,13 324,6 Q312,13 301,6 Q289,13 278,6 Q266,13 255,6 Q243,13 231,6 Q220,13 208,6 Q197,13 185,6 Q174,13 162,6 Q151,13 139,6 Q128,13 116,6 Q105,13 92,6 Q81,13 69,6 Q58,13 46,6 Q35,13 23,6 Q12,13 0,6" fill="none" stroke="#FFD100" strokeWidth="2" />
    </svg>
  );
}
