...
export function ProfileScreen() {
  ...
  return (
    <section className={`screen ${active ? 'on' : ''}`} id="screen-profile" ref={sectionRef}>
      <div className="pad-h" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        <button className="iconbtn lite" aria-label="Account settings" onClick={openSettings}>
